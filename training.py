...
def main():
    # --- Configuration ---
    # MODIFICATION: Changed to separate training and validation dataset paths.
    training_dataset_path = "phonon_training_dataset.xyz"
    validation_dataset_path = "md_validation_dataset.xyz"
    base_model_path = "/mnt/storage_3/home/krystyna_syty/pl0415-02/scratch/mace-doual-Krysia/MACE-MP_small.model"
    high_accuracy_model_path = "/mnt/storage_3/home/krystyna_syty/pl0415-02/scratch/mace-doual-Krysia/MACE-OFF24_medium.model"
    
    epochs = 100
    lr = 1e-3
    batch_size = 10
    # MODIFICATION: Removed validation_split as it's no longer needed.
