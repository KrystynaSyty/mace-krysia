...
import mbe_automation.storage as storage # Assuming storage is the alias for core.py
...
if __name__ == '__main__':
    ...
    TRAINING_OUTPUT_FILE = 'subsumple_finite_training_dataset.xyz'
    VALIDATION_OUTPUT_FILE = 'subsumple_pbc_validation_dataset.xyz'
    
    # --- NEW: SUBSAMPLING CONFIGURATION ---
    # Number of frames to select from each training/validation trajectory.
    # The selection uses farthest point sampling on the MACE feature vectors.
    N_SAMPLES_TRAIN = 500  # For finite subsystems (MD and Phonon)
    N_SAMPLES_VALID = 250  # For the PBC trajectory
